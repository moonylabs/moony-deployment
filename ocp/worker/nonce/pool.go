...
func (p *runtime) handle(ctx context.Context, record *nonce.Record) error {
...
func (p *runtime) handleReserved(ctx context.Context, record *nonce.Record) error {
	// Nothing to do here
	return nil
}

func (p *runtime) handleAvailable(ctx context.Context, record *nonce.Record) error {
	// Nothing to do here
	return nil
}

func (p *runtime) handleInvalid(ctx context.Context, record *nonce.Record) error {
	// We could try to recover this nonce account here but let's just leave it
	// as is for further investigation.
	return nil
}

func (p *runtime) handleClaimed(ctx context.Context, record *nonce.Record) error {
	// Nothing to do here
	return nil
}
