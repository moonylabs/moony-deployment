...
func (a *Account) IsManagedByCode(ctx context.Context, data ocp_data.Provider) (bool, error) {
...
// the DB
func (a *TimelockAccounts) GetDBRecord(ctx context.Context, data ocp_data.Provider) (*timelock.Record, error) {
...
func ValidateExternalTokenAccount(ctx context.Context, data ocp_data.Provider, tokenAccount, mintAccount *Account) (bool, string, error) {
